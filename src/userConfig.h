...
#define BREWSWITCHDELAY 1000       // time in ms that the brew switch will be delayed (shot timer will show that much longer after switching off)
...
#define PASS "zeowKG)0%"           // default password for WiFiManager
...
#define OTAHOST "gaggia"           // Name to be shown in Arduino IDE/PlatformIO port
#define OTAPASS "jsEsAEh8e/§ds"    // Password for OTA updates
...
#define PINSTEAMSWITCH 15
#define LEDPIN    16               // LED PIN ON near setpoint
